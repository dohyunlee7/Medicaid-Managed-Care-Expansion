...
visualization_data <- main_data %>%
  select(state, year, treatment_year) %>%
  # Create treatment status
  mutate(
    treatment_status = case_when(
      treatment_year == Inf ~ "Never Treated",
      year >= treatment_year ~ "Post-treatment",
      year < treatment_year ~ "Pre-treatment"
    )
  ) %>%
  # Make state names look nicer
  mutate(state = str_to_title(state))

# Create the plot to show treatment
png(filename = "Output/new/treatment_status.png", width=1300, height=1000, res = 150)
ggplot(visualization_data, aes(x = year, y = state)) +
  geom_tile(aes(fill = treatment_status), color = "white", width = 0.9, height = 0.9) +
  scale_fill_manual(values = c(
    "Never Treated" = "grey80",
    "Pre-treatment" = "steelblue",
    "Post-treatment" = "indianred"
  )) +
...
p2 <- did_graph_10("all_medicaid_spending_per_cap", "Medicaid Spending Per Capita")
...
png(filename = "Output/new/DID_10_MCO.png",
    width=1300, height=800, res = 150)
print(p1)
dev.off()

png(filename = "Output/new/DID_10_sp_percap.png",
    width=1300, height=800, res = 150)
print(p2)
dev.off()

png(filename = "Output/new/DID_10_log_sp_percap.png",
    width=1300, height=800, res = 150)
print(p3)
dev.off()

png(filename = "Output/new/DID_10_MCO_diff.png",
    width=1300, height=800, res = 150)
print(p4)
dev.off()

png(filename = "Output/new/DID_10_sp_percap_diff.png",
    width=1300, height=800, res = 150)
print(p5)
dev.off()

png(filename = "Output/new/DID_10_log_sp_percap_diff.png",
    width=1300, height=800, res = 150)
print(p6)
dev.off()

png(filename = "Output/new/DID_10_MCO_diff2.png",
    width=1300, height=800, res = 150)
print(p7)
dev.off()

png(filename = "Output/new/DID_10_sp_percap_diff2.png",
    width=1300, height=800, res = 150)
print(p8)
dev.off()

png(filename = "Output/new/DID_10_log_sp_percap_diff2.png",
    width=1300, height=800, res = 150)
print(p9)
dev.off()
...
png(filename = "Output/new/DID_20_MCO.png",
    width=1300, height=800, res = 150)
print(p1)
dev.off()

png(filename = "Output/new/DID_20_sp_percap.png",
    width=1300, height=800, res = 150)
print(p2)
dev.off()

png(filename = "Output/new/DID_20_log_sp_percap.png",
    width=1300, height=800, res = 150)
print(p3)
dev.off()

png(filename = "Output/new/DID_20_MCO_diff.png",
    width=1300, height=800, res = 150)
print(p4)
dev.off()

png(filename = "Output/new/DID_20_sp_percap_diff.png",
    width=1300, height=800, res = 150)
print(p5)
dev.off()

png(filename = "Output/new/DID_20_log_sp_percap_diff.png",
    width=1300, height=800, res = 150)
print(p6)
dev.off()

png(filename = "Output/new/DID_20_MCO_diff2.png",
    width=1300, height=800, res = 150)
print(p7)
dev.off()

png(filename = "Output/new/DID_20_sp_percap_diff2.png",
    width=1300, height=800, res = 150)
print(p8)
dev.off()

png(filename = "Output/new/DID_20_log_sp_percap_diff2.png",
    width=1300, height=800, res = 150)
print(p9)
dev.off()
